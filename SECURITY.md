...
The biggest concern would be arbitrary code execution via the distributed PDF edition.
Before every push to main, the PDF will be freshly recompiled from scratch after the code screening.
